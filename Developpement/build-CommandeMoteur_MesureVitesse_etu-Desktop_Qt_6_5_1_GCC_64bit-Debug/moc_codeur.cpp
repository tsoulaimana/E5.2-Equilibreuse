...
#include "../TD4_CommandeMoteur_MesureVitesse/codeur.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCodeurENDCLASS_t qt_meta_stringdata_CLASSCodeurENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 22),  // "onTimerVitesse_timeout"
        QT_MOC_LITERAL(30, 0)   // ""
    },
    "Codeur",
    "onTimerVitesse_timeout",
...
void Codeur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onTimerVitesse_timeout(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Codeur::*)();
            if (_t _q_method = &Codeur::onTimerVitesse_timeout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
